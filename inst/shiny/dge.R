...
# fastqtoSam.sh
r1Path <- system(paste("find", seqPath, "-type f -size +1G -print | grep 'R1.fastq'"), intern = TRUE)
r2Path <- system(paste("find", seqPath, "-type f -size +1G -print | grep 'R2.fastq'"), intern = TRUE)
